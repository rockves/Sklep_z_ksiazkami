...
$platnosc = $_POST['platnoscForm'];
$wysylka = $_POST['wysylkaForm'];
$data = date('Y-m-d');
$query = "INSERT INTO zamowienia (Id_klienta, Rodzaj_platnosci, Usluga_wysylki, Data_zamowienia) VALUES ('$id_klienta','$platnosc', '$wysylka', '$data')";
