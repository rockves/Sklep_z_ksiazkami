<?php
    class Ksiazka
    {
        ...
        public function __construct(string $ksiazka_tytul = '', string $ksiazka_autor = '', string $ksiazka_opis = '', string $ksiazka_gatunek = '', string $ksiazka_data = '', string $ksiazka_wydawnictwo = '', string $ksiazka_ocena = '', string $ksiazka_cena = '')
        {
        ...
        public function uploadOkladka(string $ksiazka_okladka)
        {
