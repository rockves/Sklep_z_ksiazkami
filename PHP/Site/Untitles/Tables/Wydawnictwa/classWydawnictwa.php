<?php
    ...
    class Wydawnictwo
    {
        ...
        public function __construct(string $wydawnictwo_nazwa = '')
        {
        ...
        public function insertWydawnictwo()
        {
            global $connection;
            if (!$connection) {
        ...
        public function deleteWydawnictwo()
        {
            global $connection;
            if (!$connection) {
                require_once(__DIR__.'/../../connection.php');
        ...
        public function updateWydawnictwo($nowaNazwa)
        {
            global $connection;
            if (!$connection) {
                require_once(__DIR__.'/../../connection.php');
