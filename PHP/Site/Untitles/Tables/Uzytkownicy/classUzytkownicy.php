<?php
	...
	class Uzytkownik
	{
		...
		function __construct(string $uzytkownik_nazwa = '', string $uzytkownik_haslo = '', string $uzytkownik_imie = '', string $uzytkownik_nazwisko = '', string $uzytkownik_ulica = '', string $uzytkownik_miasto = '', string $uzytkownik_kod = '', string $uzytkownik_email = '', string $uzytkownik_numer = '', string $uzytkownik_czy_pracownik = '0')
		{
